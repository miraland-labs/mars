...
#[rustfmt::skip]
pub enum MarsInstruction {
    #[account(0, name = "mars_program", desc = "Mars program")]
    #[account(1, name = "signer", desc = "Signer", signer)]
    #[account(2, name = "bus_0", desc = "Mars bus account 0", writable)]
    #[account(3, name = "bus_1", desc = "Mars bus account 1", writable)]
    #[account(4, name = "bus_2", desc = "Mars bus account 2", writable)]
    #[account(5, name = "bus_3", desc = "Mars bus account 3", writable)]
    #[account(6, name = "bus_4", desc = "Mars bus account 4", writable)]
    #[account(7, name = "bus_5", desc = "Mars bus account 5", writable)]
    #[account(8, name = "bus_6", desc = "Mars bus account 6", writable)]
    #[account(9, name = "bus_7", desc = "Mars bus account 7", writable)]
    #[account(10, name = "mint", desc = "Mars token mint account", writable)]
    #[account(11, name = "treasury", desc = "Mars treasury account", writable)]
    #[account(12, name = "treasury_tokens", desc = "Mars treasury token account", writable)]
    #[account(13, name = "token_program", desc = "SPL token program")]
    Reset = 0,

    #[account(0, name = "mars_program", desc = "Mars program")]
    #[account(1, name = "signer", desc = "Signer", signer)]
    #[account(2, name = "proof", desc = "Mars proof account", writable)]
    #[account(3, name = "system_program", desc = "Solana system program")]
    Register = 1,

    #[account(0, name = "mars_program", desc = "Mars program")]
    #[account(1, name = "signer", desc = "Signer", signer)]
    #[account(2, name = "bus", desc = "Mars bus account", writable)]
    #[account(3, name = "proof", desc = "Mars proof account", writable)]
    #[account(4, name = "treasury", desc = "Mars treasury account")]
    ...
    #[account(3, name = "proof", desc = "Mars proof account", writable)]
    #[account(4, name = "treasury", desc = "Mars treasury account", writable)]
    #[account(5, name = "treasury_tokens", desc = "Mars treasury token account", writable)]
    ...
    #[account(8, name = "bus_6", desc = "Mars bus account 6", writable)]
    #[account(9, name = "bus_7", desc = "Mars bus account 7", writable)]
    #[account(10, name = "metadata", desc = "Mars mint metadata account", writable)]
    #[account(11, name = "mint", desc = "Mars mint account", writable)]
    #[account(12, name = "treasury", desc = "Mars treasury account", writable)]
    #[account(13, name = "treasury_tokens", desc = "Mars treasury token account", writable)]
    ...
    #[account(0, name = "mars_program", desc = "Mars program")]
    #[account(1, name = "signer", desc = "Admin signer", signer)]
    #[account(2, name = "treasury", desc = "Mars treasury account")]
    UpdateAdmin = 101,
...
pub fn register(signer: Pubkey) -> Instruction {
    ...
    Instruction {
        ...
        data: [
            MarsInstruction::Register.to_vec(),
...
pub fn initialize(signer: Pubkey) -> Instruction {
    ...
    Instruction {
        ...
        data: [
            MarsInstruction::Initialize.to_vec(),
            InitializeArgs {
...
pub fn update_admin(signer: Pubkey, new_admin: Pubkey) -> Instruction {
    Instruction {
        ...
        data: [
            MarsInstruction::UpdateAdmin.to_vec(),
...
pub fn update_difficulty(signer: Pubkey, new_difficulty: Hash) -> Instruction {
    Instruction {
        ...
        data: [
            MarsInstruction::UpdateDifficulty.to_vec(),
